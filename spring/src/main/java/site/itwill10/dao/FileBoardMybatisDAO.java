...
@Repository
public class FileBoardMybatisDAO implements FileBoardDAO {
	@Autowired
	...
	@Override
	public List<FileBoard> selectAllFileBoard() {
		return sqlSession.getMapper(FileBoardMapper.class).selectAllFileBoard();
	}
}
