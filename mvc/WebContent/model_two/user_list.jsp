...
<%-- 모델 클래스에서 공유한 회원목록을 반환받아 출력하는 JSP 문서 --%>
<%-- => [회원이름]을 클릭한 경우 회원상세 출력페이지(view.do) 요청 --%>
<%-- => [로그아웃]을 클릭한 경우 로그아웃 처리페이지(logout.do) 요청 --%>
<%-- => [회원등록]을 클릭한 경우 회원등록 입력페이지(writeForm.do) 요청 - 관리자만 출력 --%>
